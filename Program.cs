...
namespace Fix_LCU_Window
{
    class Program
    {
        ...
        public static async Task<int> FixLeagueClientWindow(bool forced = false)
        {
        ...
        public  static async Task<string> Plan1()
        {
        ...
        public static async Task<string> Plan3()
        {
            var LeagueClientAPIClient = GetLCU();
        ...
        public static async Task<string> Plan4()
        {
            var LeagueClientAPIClient = GetLCU();
